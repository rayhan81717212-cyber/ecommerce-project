...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('site-asset/css/elegant-icons.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('site-asset/css/nice-select.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('site-asset/css/jquery-ui.min.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('site-asset/css/owl.carousel.min.css') }}" type="text/css">
