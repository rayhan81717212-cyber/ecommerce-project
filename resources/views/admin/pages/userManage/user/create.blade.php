...
@section('content')
    ...
    <div class="card-body">
        ...
        <ul class="nav nav-pills mb-4">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#step2">Step 2: Password <span class="text-success d-none step-done">&#10003;</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#step3">Step 3: Phone, Role and Status <span class="text-success d-none step-done">&#10003;</span></a>
            </li>
            <li class="nav-item">
        ...
        <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
            @csrf
            ...
            <div id="step3" class="step-content d-none">
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        <label>phone</label>
                        <input type="text" name="phone" class="form-control" class="form-control" value="{{ old('phone') }}">
                        @error("phone")
                            <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
